import astronaut from '/public/images/illustrations/404.svg';
import Image from 'next/image';
export default function NotFoundPage() {
  return (
    <div className='d-flex flex-column min-vh-100'>
      <main className='p-5 my-auto' id='content'>
        <div className='flex flex-col justify-center items-center px-6 mx-auto h-screen xl:px-0 dark:bg-gray-900'>
          <div className='block md:max-w-lg'>
            <Image src={astronaut} alt='astronaut image' priority />
          </div>
          <div className='text-center xl:max-w-4xl'>
            ...
            focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-3
