...
import { setIsSubmittingNationalCard } from '@/store/slices/setupSlice/setupSlice';

export default function NationalCardForm() {
  const dispatch = useAppDispatch();
  const { isSubmittingNationalCard } = useAppSelector((state) => state.setup);
